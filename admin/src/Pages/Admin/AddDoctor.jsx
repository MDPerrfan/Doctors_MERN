    ...
    <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
      ...
      <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
        ...
        <div className='flex-1 flex flex-col gap-1'>
            <p>Doctor Name</p>
            <input className='border rounded px-3 py-2' type="text" placeholder='Doctor Name' required />
          </div>
          <div className='flex-1 flex flex-col gap-1'>
            <p>Doctor Email</p>
            <input className='border rounded px-3 py-2' type="email" placeholder='Doctor Email' required />
          </div>
          <div className='flex-1 flex flex-col gap-1'>
            <p>Doctor Password</p>
        ...
        <div className='w-full lg:flex flex-1 flex-col gap-4'>
          ...
          <div className='flex-1 flex flex-col gap-1'>
            <p>Address</p>
            <input className='border rounded px-3 py-2' type="text" placeholder='Address one' required />
            <input className='border rounded px-3 py-2' type="text" placeholder='Address two' required />
          </div>
        </div>
      </div>
      <div>
      ...
      <button className='px-10 py-3 text-white rounded-full bg-primary mt-1'>Add Doctor</button>
    </div>
  </form>
