    ...
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
        {doctors.slice(0,12).map((item,index)=>(
            <div className='border border-green-900 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500' key={index}>
      ...
      <button className='bg-gray-100 px-12 py-3 rounded-full mt-9 '>more</button>
    </div>
  )
}
